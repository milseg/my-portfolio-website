...
const HackyThings: React.FC<PageProps> = () => {
  ...
  const aboutP3 = `Sports Betting platforms usually have the requirement to fetch odds data for matches and it costs them a significant amount to their budget to hire an API supplier. I have once developed a system that scrapped data from competitors by using PHP+selenium in a trustable way for less than 5$/month. He was a small player in the market and it allowed him to have a chance to thrive`
